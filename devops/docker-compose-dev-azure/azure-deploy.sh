...
# git clone https://github.com/apilogicserver/oukash5.git
# cd oukash5
...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name oukash5 --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
