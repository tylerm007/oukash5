...
RUN pip install --upgrade pip && \
    pip install pyodbc==5.2.0 boto3 cryptography PyJWT msal schedule openpyxl xlrd pgvector psycopg2-binary langchain langchain_postgres langchain_community fastembed boto3
