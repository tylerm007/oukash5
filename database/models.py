...
class SubmissionApplication(Base):  # type: ignore
    ...
    _s_collection_name = 'SubmissionApplication'  # type: ignore
    ...
    ZipPostalCode = Column(Unicode(15, 'SQL_Latin1_General_CP1_CI_AS'))
    ...
    copack = Column(Unicode(10, 'SQL_Latin1_General_CP1_CI_AS'))
...
class SubmissionPlant(Base):  # type: ignore
    ...
    _s_collection_name = 'SubmissionPlant'  # type: ignore
    __bind_key__ = 'submission'
    ...
    plantAddress = Column(Unicode(100, 'SQL_Latin1_General_CP1_CI_AS'))
...
class SubmissionRawDatum(Base):  # type: ignore
    ...
    _s_collection_name = 'SubmissionRawDatum'  # type: ignore
    __bind_key__ = 'submission'
...
class SubmissionIngredient(Base):  # type: ignore
    ...
    _s_collection_name = 'SubmissionIngredient'  # type: ignore
    __bind_key__ = 'submission'
...
class SubmissionProduct(Base):  # type: ignore
    ...
    _s_collection_name = 'SubmissionProduct'  # type: ignore
    __bind_key__ = 'submission'
...
class SubmissionFile(Base):  # type: ignore
    ...
    _s_collection_name = 'SubmissionFile'  # type: ignore
    __bind_key__ = 'submission'
...
class SubmissionFileLink(Base):  # type: ignore
    ...
    _s_collection_name = 'SubmissionFileLink'  # type: ignore
    __bind_key__ = 'submission'
...
class SubmissionMatcher(Base):  # type: ignore
    ...
    _s_collection_name = 'SubmissionMatcher'  # type: ignore
    __bind_key__ = 'submission'
