...
class v_Labels(Base):
    ...
    INSTITUTIONAL = Column(Boolean, nullable=False)
    BLK = Column(Boolean, nullable=False)
    SEAL_SIGN = Column(Boolean, nullable=False)
    GRP = Column(Boolean, nullable=False)
    SEAL_SIGN_FLAG = Column(Boolean, nullable=False)
    ...
    SPECIAL_PRODUCTION = Column(Boolean, nullable=False)
    ...
    JEWISH_ACTION = Column(Boolean, nullable=False)
    ...
    LOChold = Column(Boolean, nullable=False)
    LOCholdDate = Column(DATETIME2, nullable=False)
    PassoverSpecialProduction = Column(Boolean, nullable=False)
    COMMENT = Column(String(255), nullable=False)
    DisplayNewlyCertifiedOnWeb = Column(Boolean, nullable=False)
    ...
    Kitniyot = Column(Boolean, nullable=False)
    IsDairyEquipment = Column(Boolean, nullable=False)
    NameNum = Column(String(40), nullable=False)
    AS_STIPULATED = Column(Boolean, nullable=False)
    STIPULATION = Column(Boolean, nullable=False)
    RETAIL = Column(Boolean, nullable=False)
    FOODSERVICE = Column(Boolean, nullable=False)
    OUP_REQUIRED = Column(Boolean, nullable=False)
    GENERIC = Column(Boolean, nullable=False)
    SPECIFIED_SOURCE = Column(Boolean, nullable=False)
    SPECIFIED_SYMBOL = Column(Boolean, nullable=False)
    DESCRIPTION = Column(String(255), nullable=False)
    DPM = Column(Boolean, nullable=False)
    PESACH = Column(Boolean, nullable=False)
    COMMENT = Column(String(255), nullable=False)
    ...
    UKDdisplay = Column(Boolean, nullable=False)
...
class v_Plants(Base):
    ...
    GP_NOTIFY = Column(Boolean, nullable=False)
    MULTILINES = Column(Boolean, nullable=False)
    PASSOVER = Column(Boolean, nullable=False)
    SPECIAL_PROD = Column(Boolean, nullable=False)
    JEWISH_OWNED = Column(Boolean, nullable=False)
    ...
    DoNotAttach = Column(Boolean, nullable=False)
