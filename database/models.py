...
t_ASSIGNED_MASHGIACH = Table(
    ...
    Column('SEASONAL_START', String(3)),
    Column('SEASONAL_END', String(3)),
    Column('TIMESTAMP', DateTime),
    Column('OWNS_ID', Integer, nullable=False),
    Column('company_id', Integer, nullable=False),
    Column('OwnsStatus', String(40))
)
...
t_ASSIGNED_MASHGIACH_OLD = Table(
    ...
    Column('END_DATE', DateTime),
    Column('VIST_TYPE', String(20)),
    Column('VISIT_PERIOD1', String(20)),
    Column('VISIT_PERIOD2', String(20)),
    Column('VISIT_PERIOD3', String(20)),
    Column('VISIT_PERIOD_SEASONAL', String(10)),
    Column('SEASONAL_START', String(3)),
    Column('SEASONAL_END', String(3)),
    Column('DESIGNATED_MASHGIACH_FLAG', String(1)),
    Column('TIMESTAMP', BINARY(8)),
    Column('DESIGNATED_MASHGIACH', String(150)),
...
class ASSIGNEDMASHGIACHTB(Base):  # type: ignore
    ...
    VIST_TYPE = Column(String(20))
    VISIT_PERIOD1 = Column(String(20))
    VISIT_PERIOD2 = Column(String(20))
    VISIT_PERIOD3 = Column(String(20))
    VISIT_PERIOD_SEASONAL = Column(String(1))
    SEASONAL_START = Column(String(3))
    SEASONAL_END = Column(String(3))
    DESIGNATED_MASHGIACH_FLAG = Column(String(1))
    ACTIVE = Column(Integer)
    DESIGNATED_MASHGIACH = Column(String(150))
...
t_ASSIGNED_MASHGIACH_TB_history_temporal = Table(
    ...
    Column('VISIT_PERIOD2', String(20)),
    Column('VISIT_PERIOD3', String(20)),
    Column('VISIT_PERIOD_SEASONAL', String(1)),
    Column('SEASONAL_START', String(3)),
    Column('SEASONAL_END', String(3)),
    Column('DESIGNATED_MASHGIACH_FLAG', String(1)),
    ...
    Column('Discriminator', String(1)),
    Column('Zone', String(10)),
...
t_CODE_TB_history_temporal = Table(
    ...
    Column('FIELD_VALUE', String(500), nullable=False),
    Column('VALUE_DESCRIPTION', String(255)),
    Column('PERSON_ID', String(50)),
    Column('TIMESTAMP', DateTime),
    Column('ACTIVE', Integer),
...
t_CompanyContacts = Table(
    ...
    Column('Cell', String(50)),
    Column('PrimaryCT', String(1), nullable=False),
    Column('BillingCT', String(1), nullable=False),
    Column('WebCT', String(1), nullable=False),
    Column('OtherCT', String(1), nullable=False),
    ...
    Column('OtherInfo', String(100)),
    Column('StatementType', String(1), nullable=False),
    Column('InvoiceType', String(1), nullable=False),
...
t_CompanyContactsAndAddresses = Table(
    ...
    Column('Fax', String(50)),
    Column('Email', String(100)),
    Column('ContactType', String(23), nullable=False),
    Column('Street1', String(60)),
    Column('Street2', String(60)),
    Column('City', String(40)),
    Column('State', String(25)),
