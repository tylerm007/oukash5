...
class Config:
    ...
    SQLALCHEMY_DATABASEV1_URI : typing.Optional[str] = f"mssql+pyodbc://apilogic:2Rtrzc8iLovpU!Hv8gG*@kash-sql-st.nyc.ou.org/dashboardV1?driver=ODBC+Driver+17+for+SQL+Server&trusted_connection=no&Encrypt=no"
