...
@Component({
  selector: 'WFPriority-home',
  templateUrl: './WFPriority-home.component.html',
  styleUrls: ['./WFPriority-home.component.scss']
})
export class WFPriorityHomeComponent implements AfterViewInit {
