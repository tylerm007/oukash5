...
@Component({
  selector: 'WFCompany-home',
  templateUrl: './WFCompany-home.component.html',
  styleUrls: ['./WFCompany-home.component.scss']
})
export class WFCompanyHomeComponent implements AfterViewInit {
