...
@Component({
  selector: 'WFQuote-home',
  templateUrl: './WFQuote-home.component.html',
  styleUrls: ['./WFQuote-home.component.scss']
})
export class WFQuoteHomeComponent implements AfterViewInit {
