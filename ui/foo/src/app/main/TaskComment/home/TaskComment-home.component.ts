...
@Component({
  selector: 'TaskComment-home',
  templateUrl: './TaskComment-home.component.html',
  styleUrls: ['./TaskComment-home.component.scss']
})
export class TaskCommentHomeComponent implements AfterViewInit {
