...
@Component({
  selector: 'WFApplicationMessage-home',
  templateUrl: './WFApplicationMessage-home.component.html',
  styleUrls: ['./WFApplicationMessage-home.component.scss']
})
export class WFApplicationMessageHomeComponent implements AfterViewInit {
