...
@Component({
  selector: 'PLANTCERTDETAIL-home',
  templateUrl: './PLANTCERTDETAIL-home.component.html',
  styleUrls: ['./PLANTCERTDETAIL-home.component.scss']
})
export class PLANTCERTDETAILHomeComponent implements AfterViewInit {
