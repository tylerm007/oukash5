...
@Component({
  selector: 'WFApplication-home',
  templateUrl: './WFApplication-home.component.html',
  styleUrls: ['./WFApplication-home.component.scss']
})
export class WFApplicationHomeComponent implements AfterViewInit {
