...
@Component({
  selector: 'WFQuoteItem-home',
  templateUrl: './WFQuoteItem-home.component.html',
  styleUrls: ['./WFQuoteItem-home.component.scss']
})
export class WFQuoteItemHomeComponent implements AfterViewInit {
