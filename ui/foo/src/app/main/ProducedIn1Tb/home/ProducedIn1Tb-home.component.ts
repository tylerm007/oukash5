...
@Component({
  selector: 'ProducedIn1Tb-home',
  templateUrl: './ProducedIn1Tb-home.component.html',
  styleUrls: ['./ProducedIn1Tb-home.component.scss']
})
export class ProducedIn1TbHomeComponent implements AfterViewInit {
