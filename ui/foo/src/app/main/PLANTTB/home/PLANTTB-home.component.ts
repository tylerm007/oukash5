...
@Component({
  selector: 'PLANTTB-home',
  templateUrl: './PLANTTB-home.component.html',
  styleUrls: ['./PLANTTB-home.component.scss']
})
export class PLANTTBHomeComponent implements AfterViewInit {
