...
@Component({
  selector: 'WFApplicationComment-home',
  templateUrl: './WFApplicationComment-home.component.html',
  styleUrls: ['./WFApplicationComment-home.component.scss']
})
export class WFApplicationCommentHomeComponent implements AfterViewInit {
