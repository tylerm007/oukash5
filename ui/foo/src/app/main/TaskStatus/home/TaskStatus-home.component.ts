...
@Component({
  selector: 'TaskStatus-home',
  templateUrl: './TaskStatus-home.component.html',
  styleUrls: ['./TaskStatus-home.component.scss']
})
export class TaskStatusHomeComponent implements AfterViewInit {
