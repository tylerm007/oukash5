...
@Component({
  selector: 'WFDashboard-home',
  templateUrl: './WFDashboard-home.component.html',
  styleUrls: ['./WFDashboard-home.component.scss']
})
export class WFDashboardHomeComponent implements AfterViewInit {
