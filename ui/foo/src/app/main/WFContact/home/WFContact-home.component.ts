...
@Component({
  selector: 'WFContact-home',
  templateUrl: './WFContact-home.component.html',
  styleUrls: ['./WFContact-home.component.scss']
})
export class WFContactHomeComponent implements AfterViewInit {
