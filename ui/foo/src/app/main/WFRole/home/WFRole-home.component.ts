...
@Component({
  selector: 'WFRole-home',
  templateUrl: './WFRole-home.component.html',
  styleUrls: ['./WFRole-home.component.scss']
})
export class WFRoleHomeComponent implements AfterViewInit {
