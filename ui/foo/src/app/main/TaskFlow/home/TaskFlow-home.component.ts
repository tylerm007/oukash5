...
@Component({
  selector: 'TaskFlow-home',
  templateUrl: './TaskFlow-home.component.html',
  styleUrls: ['./TaskFlow-home.component.scss']
})
export class TaskFlowHomeComponent implements AfterViewInit {
