...
@Component({
  selector: 'WorkflowHistory-home',
  templateUrl: './WorkflowHistory-home.component.html',
  styleUrls: ['./WorkflowHistory-home.component.scss']
})
export class WorkflowHistoryHomeComponent implements AfterViewInit {
