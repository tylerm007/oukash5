...
@Component({
  selector: 'COMPANYTB-home',
  templateUrl: './COMPANYTB-home.component.html',
  styleUrls: ['./COMPANYTB-home.component.scss']
})
export class COMPANYTBHomeComponent implements AfterViewInit {
