...
@Component({
  selector: 'ProcessPriority-home',
  templateUrl: './ProcessPriority-home.component.html',
  styleUrls: ['./ProcessPriority-home.component.scss']
})
export class ProcessPriorityHomeComponent implements AfterViewInit {
