...
@Component({
  selector: 'AchStripePayment-home',
  templateUrl: './AchStripePayment-home.component.html',
  styleUrls: ['./AchStripePayment-home.component.scss']
})
export class AchStripePaymentHomeComponent implements AfterViewInit {
