...
@Component({
  selector: 'PLANTHOLDTB-home',
  templateUrl: './PLANTHOLDTB-home.component.html',
  styleUrls: ['./PLANTHOLDTB-home.component.scss']
})
export class PLANTHOLDTBHomeComponent implements AfterViewInit {
