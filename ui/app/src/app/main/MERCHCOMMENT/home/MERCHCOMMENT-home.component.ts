...
@Component({
  selector: 'MERCHCOMMENT-home',
  templateUrl: './MERCHCOMMENT-home.component.html',
  styleUrls: ['./MERCHCOMMENT-home.component.scss']
})
export class MERCHCOMMENTHomeComponent implements AfterViewInit {
