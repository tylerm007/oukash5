...
@Component({
  selector: 'AchPlaidLambdaResponse-home',
  templateUrl: './AchPlaidLambdaResponse-home.component.html',
  styleUrls: ['./AchPlaidLambdaResponse-home.component.scss']
})
export class AchPlaidLambdaResponseHomeComponent implements AfterViewInit {
