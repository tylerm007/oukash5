...
@Component({
  selector: 'EventAction-home',
  templateUrl: './EventAction-home.component.html',
  styleUrls: ['./EventAction-home.component.scss']
})
export class EventActionHomeComponent implements AfterViewInit {
