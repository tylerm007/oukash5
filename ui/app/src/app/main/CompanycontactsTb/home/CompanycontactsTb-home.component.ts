...
@Component({
  selector: 'CompanycontactsTb-home',
  templateUrl: './CompanycontactsTb-home.component.html',
  styleUrls: ['./CompanycontactsTb-home.component.scss']
})
export class CompanycontactsTbHomeComponent implements AfterViewInit {
