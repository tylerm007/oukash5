...
@Component({
  selector: 'COMPANYCOMMENT-home',
  templateUrl: './COMPANYCOMMENT-home.component.html',
  styleUrls: ['./COMPANYCOMMENT-home.component.scss']
})
export class COMPANYCOMMENTHomeComponent implements AfterViewInit {
