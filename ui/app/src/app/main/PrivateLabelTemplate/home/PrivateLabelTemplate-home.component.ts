...
@Component({
  selector: 'PrivateLabelTemplate-home',
  templateUrl: './PrivateLabelTemplate-home.component.html',
  styleUrls: ['./PrivateLabelTemplate-home.component.scss']
})
export class PrivateLabelTemplateHomeComponent implements AfterViewInit {
