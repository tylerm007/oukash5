...
@Component({
  selector: 'USEDIN1TB-home',
  templateUrl: './USEDIN1TB-home.component.html',
  styleUrls: ['./USEDIN1TB-home.component.scss']
})
export class USEDIN1TBHomeComponent implements AfterViewInit {
