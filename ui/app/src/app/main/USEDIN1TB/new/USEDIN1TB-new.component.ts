...
export class USEDIN1TBNewComponent {
  ...
  onInsertMode() {
    const default_values = {'ID': '0', 'START_DATE': 'getdate()', 'ValidFromTime': "(CONVERT([datetime2](7),'1900-01-01 00:00:00'))", 'ValidToTime': "(CONVERT([datetime2](7),'9999-12-31 23:59:59.9999999'))"}
