...
@Component({
  selector: 'ProcessMessageType-home',
  templateUrl: './ProcessMessageType-home.component.html',
  styleUrls: ['./ProcessMessageType-home.component.scss']
})
export class ProcessMessageTypeHomeComponent implements AfterViewInit {
