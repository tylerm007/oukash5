...
@Component({
  selector: 'LabelComment-home',
  templateUrl: './LabelComment-home.component.html',
  styleUrls: ['./LabelComment-home.component.scss']
})
export class LabelCommentHomeComponent implements AfterViewInit {
