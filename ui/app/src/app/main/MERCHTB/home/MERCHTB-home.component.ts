...
@Component({
  selector: 'MERCHTB-home',
  templateUrl: './MERCHTB-home.component.html',
  styleUrls: ['./MERCHTB-home.component.scss']
})
export class MERCHTBHomeComponent implements AfterViewInit {
