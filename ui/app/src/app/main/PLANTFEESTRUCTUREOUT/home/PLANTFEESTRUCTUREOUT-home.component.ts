...
@Component({
  selector: 'PLANTFEESTRUCTUREOUT-home',
  templateUrl: './PLANTFEESTRUCTUREOUT-home.component.html',
  styleUrls: ['./PLANTFEESTRUCTUREOUT-home.component.scss']
})
export class PLANTFEESTRUCTUREOUTHomeComponent implements AfterViewInit {
