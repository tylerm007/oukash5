...
@Component({
  selector: 'ProcessStatus-home',
  templateUrl: './ProcessStatus-home.component.html',
  styleUrls: ['./ProcessStatus-home.component.scss']
})
export class ProcessStatusHomeComponent implements AfterViewInit {
