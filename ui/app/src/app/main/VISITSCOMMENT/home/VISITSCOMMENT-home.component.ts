...
@Component({
  selector: 'VISITSCOMMENT-home',
  templateUrl: './VISITSCOMMENT-home.component.html',
  styleUrls: ['./VISITSCOMMENT-home.component.scss']
})
export class VISITSCOMMENTHomeComponent implements AfterViewInit {
