...
@Component({
  selector: 'ProductJobLineItem-home',
  templateUrl: './ProductJobLineItem-home.component.html',
  styleUrls: ['./ProductJobLineItem-home.component.scss']
})
export class ProductJobLineItemHomeComponent implements AfterViewInit {
