...
@Component({
  selector: 'COMPANYFEECOMMENT-home',
  templateUrl: './COMPANYFEECOMMENT-home.component.html',
  styleUrls: ['./COMPANYFEECOMMENT-home.component.scss']
})
export class COMPANYFEECOMMENTHomeComponent implements AfterViewInit {
