...
@Component({
  selector: 'MiniCRMAction-home',
  templateUrl: './MiniCRMAction-home.component.html',
  styleUrls: ['./MiniCRMAction-home.component.scss']
})
export class MiniCRMActionHomeComponent implements AfterViewInit {
