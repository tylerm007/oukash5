...
@Component({
  selector: 'WFPlant-home',
  templateUrl: './WFPlant-home.component.html',
  styleUrls: ['./WFPlant-home.component.scss']
})
export class WFPlantHomeComponent implements AfterViewInit {
