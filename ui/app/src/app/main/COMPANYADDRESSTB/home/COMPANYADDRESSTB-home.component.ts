...
@Component({
  selector: 'COMPANYADDRESSTB-home',
  templateUrl: './COMPANYADDRESSTB-home.component.html',
  styleUrls: ['./COMPANYADDRESSTB-home.component.scss']
})
export class COMPANYADDRESSTBHomeComponent implements AfterViewInit {
