...
@Component({
  selector: 'COMPANYSTATUSTB-home',
  templateUrl: './COMPANYSTATUSTB-home.component.html',
  styleUrls: ['./COMPANYSTATUSTB-home.component.scss']
})
export class COMPANYSTATUSTBHomeComponent implements AfterViewInit {
