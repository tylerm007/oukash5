...
@Component({
  selector: 'PERSONTB-home',
  templateUrl: './PERSONTB-home.component.html',
  styleUrls: ['./PERSONTB-home.component.scss']
})
export class PERSONTBHomeComponent implements AfterViewInit {
