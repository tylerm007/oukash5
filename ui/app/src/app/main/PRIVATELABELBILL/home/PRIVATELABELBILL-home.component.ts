...
@Component({
  selector: 'PRIVATELABELBILL-home',
  templateUrl: './PRIVATELABELBILL-home.component.html',
  styleUrls: ['./PRIVATELABELBILL-home.component.scss']
})
export class PRIVATELABELBILLHomeComponent implements AfterViewInit {
