...
@Component({
  selector: 'CODETB-home',
  templateUrl: './CODETB-home.component.html',
  styleUrls: ['./CODETB-home.component.scss']
})
export class CODETBHomeComponent implements AfterViewInit {
