...
@Component({
  selector: 'ASSIGNEDMASHGIACHTB-home',
  templateUrl: './ASSIGNEDMASHGIACHTB-home.component.html',
  styleUrls: ['./ASSIGNEDMASHGIACHTB-home.component.scss']
})
export class ASSIGNEDMASHGIACHTBHomeComponent implements AfterViewInit {
