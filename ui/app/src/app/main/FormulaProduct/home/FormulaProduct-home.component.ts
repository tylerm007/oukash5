...
@Component({
  selector: 'FormulaProduct-home',
  templateUrl: './FormulaProduct-home.component.html',
  styleUrls: ['./FormulaProduct-home.component.scss']
})
export class FormulaProductHomeComponent implements AfterViewInit {
