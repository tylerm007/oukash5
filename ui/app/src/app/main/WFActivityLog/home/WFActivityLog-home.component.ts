...
@Component({
  selector: 'WFActivityLog-home',
  templateUrl: './WFActivityLog-home.component.html',
  styleUrls: ['./WFActivityLog-home.component.scss']
})
export class WFActivityLogHomeComponent implements AfterViewInit {
