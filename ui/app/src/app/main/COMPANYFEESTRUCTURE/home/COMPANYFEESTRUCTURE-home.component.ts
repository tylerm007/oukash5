...
@Component({
  selector: 'COMPANYFEESTRUCTURE-home',
  templateUrl: './COMPANYFEESTRUCTURE-home.component.html',
  styleUrls: ['./COMPANYFEESTRUCTURE-home.component.scss']
})
export class COMPANYFEESTRUCTUREHomeComponent implements AfterViewInit {
