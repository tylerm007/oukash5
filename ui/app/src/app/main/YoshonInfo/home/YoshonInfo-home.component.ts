...
@Component({
  selector: 'YoshonInfo-home',
  templateUrl: './YoshonInfo-home.component.html',
  styleUrls: ['./YoshonInfo-home.component.scss']
})
export class YoshonInfoHomeComponent implements AfterViewInit {
