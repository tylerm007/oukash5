...
@Component({
  selector: 'Sysdiagram-home',
  templateUrl: './Sysdiagram-home.component.html',
  styleUrls: ['./Sysdiagram-home.component.scss']
})
export class SysdiagramHomeComponent implements AfterViewInit {
