...
@Component({
  selector: 'WFApplicationStatus-home',
  templateUrl: './WFApplicationStatus-home.component.html',
  styleUrls: ['./WFApplicationStatus-home.component.scss']
})
export class WFApplicationStatusHomeComponent implements AfterViewInit {
