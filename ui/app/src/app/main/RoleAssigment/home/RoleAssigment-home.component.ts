...
@Component({
  selector: 'RoleAssigment-home',
  templateUrl: './RoleAssigment-home.component.html',
  styleUrls: ['./RoleAssigment-home.component.scss']
})
export class RoleAssigmentHomeComponent implements AfterViewInit {
