...
@Component({
  selector: 'INVOICEFEESDETAIL-home',
  templateUrl: './INVOICEFEESDETAIL-home.component.html',
  styleUrls: ['./INVOICEFEESDETAIL-home.component.scss']
})
export class INVOICEFEESDETAILHomeComponent implements AfterViewInit {
