...
@Component({
  selector: 'ValidationResult-home',
  templateUrl: './ValidationResult-home.component.html',
  styleUrls: ['./ValidationResult-home.component.scss']
})
export class ValidationResultHomeComponent implements AfterViewInit {
