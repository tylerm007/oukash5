...
@Component({
  selector: 'PLANTFEECOMMENT-home',
  templateUrl: './PLANTFEECOMMENT-home.component.html',
  styleUrls: ['./PLANTFEECOMMENT-home.component.scss']
})
export class PLANTFEECOMMENTHomeComponent implements AfterViewInit {
