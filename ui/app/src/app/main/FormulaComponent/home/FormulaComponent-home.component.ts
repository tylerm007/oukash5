...
@Component({
  selector: 'FormulaComponent-home',
  templateUrl: './FormulaComponent-home.component.html',
  styleUrls: ['./FormulaComponent-home.component.scss']
})
export class FormulaComponentHomeComponent implements AfterViewInit {
