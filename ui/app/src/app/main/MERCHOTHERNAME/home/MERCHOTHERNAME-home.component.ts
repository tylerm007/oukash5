...
@Component({
  selector: 'MERCHOTHERNAME-home',
  templateUrl: './MERCHOTHERNAME-home.component.html',
  styleUrls: ['./MERCHOTHERNAME-home.component.scss']
})
export class MERCHOTHERNAMEHomeComponent implements AfterViewInit {
