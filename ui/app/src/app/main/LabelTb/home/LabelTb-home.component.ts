...
@Component({
  selector: 'LabelTb-home',
  templateUrl: './LabelTb-home.component.html',
  styleUrls: ['./LabelTb-home.component.scss']
})
export class LabelTbHomeComponent implements AfterViewInit {
