...
@Component({
  selector: 'AchStripePaymentDetail-home',
  templateUrl: './AchStripePaymentDetail-home.component.html',
  styleUrls: ['./AchStripePaymentDetail-home.component.scss']
})
export class AchStripePaymentDetailHomeComponent implements AfterViewInit {
