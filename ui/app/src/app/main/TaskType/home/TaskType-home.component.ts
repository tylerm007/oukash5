...
@Component({
  selector: 'TaskType-home',
  templateUrl: './TaskType-home.component.html',
  styleUrls: ['./TaskType-home.component.scss']
})
export class TaskTypeHomeComponent implements AfterViewInit {
