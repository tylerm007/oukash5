...
@Component({
  selector: 'TaskCategory-home',
  templateUrl: './TaskCategory-home.component.html',
  styleUrls: ['./TaskCategory-home.component.scss']
})
export class TaskCategoryHomeComponent implements AfterViewInit {
