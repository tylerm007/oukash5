...
@Component({
  selector: 'OWNSTB-home',
  templateUrl: './OWNSTB-home.component.html',
  styleUrls: ['./OWNSTB-home.component.scss']
})
export class OWNSTBHomeComponent implements AfterViewInit {
