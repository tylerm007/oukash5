...
@Component({
  selector: 'PLANTSTATUSTB-home',
  templateUrl: './PLANTSTATUSTB-home.component.html',
  styleUrls: ['./PLANTSTATUSTB-home.component.scss']
})
export class PLANTSTATUSTBHomeComponent implements AfterViewInit {
