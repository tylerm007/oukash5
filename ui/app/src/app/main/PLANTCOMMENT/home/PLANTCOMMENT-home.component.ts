...
@Component({
  selector: 'PLANTCOMMENT-home',
  templateUrl: './PLANTCOMMENT-home.component.html',
  styleUrls: ['./PLANTCOMMENT-home.component.scss']
})
export class PLANTCOMMENTHomeComponent implements AfterViewInit {
