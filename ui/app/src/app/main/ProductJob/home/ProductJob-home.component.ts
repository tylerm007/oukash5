...
@Component({
  selector: 'ProductJob-home',
  templateUrl: './ProductJob-home.component.html',
  styleUrls: ['./ProductJob-home.component.scss']
})
export class ProductJobHomeComponent implements AfterViewInit {
