...
@Component({
  selector: 'LaneDefinition-home',
  templateUrl: './LaneDefinition-home.component.html',
  styleUrls: ['./LaneDefinition-home.component.scss']
})
export class LaneDefinitionHomeComponent implements AfterViewInit {
