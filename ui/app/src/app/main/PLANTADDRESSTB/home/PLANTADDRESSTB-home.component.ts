...
@Component({
  selector: 'PLANTADDRESSTB-home',
  templateUrl: './PLANTADDRESSTB-home.component.html',
  styleUrls: ['./PLANTADDRESSTB-home.component.scss']
})
export class PLANTADDRESSTBHomeComponent implements AfterViewInit {
