...
@Component({
  selector: 'StageDefinition-home',
  templateUrl: './StageDefinition-home.component.html',
  styleUrls: ['./StageDefinition-home.component.scss']
})
export class StageDefinitionHomeComponent implements AfterViewInit {
