...
@Component({
  selector: 'WFProduct-home',
  templateUrl: './WFProduct-home.component.html',
  styleUrls: ['./WFProduct-home.component.scss']
})
export class WFProductHomeComponent implements AfterViewInit {
