...
@Component({
  selector: 'COMPANYOTHERNAME-home',
  templateUrl: './COMPANYOTHERNAME-home.component.html',
  styleUrls: ['./COMPANYOTHERNAME-home.component.scss']
})
export class COMPANYOTHERNAMEHomeComponent implements AfterViewInit {
