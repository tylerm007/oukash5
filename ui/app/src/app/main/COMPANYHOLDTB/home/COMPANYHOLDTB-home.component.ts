...
@Component({
  selector: 'COMPANYHOLDTB-home',
  templateUrl: './COMPANYHOLDTB-home.component.html',
  styleUrls: ['./COMPANYHOLDTB-home.component.scss']
})
export class COMPANYHOLDTBHomeComponent implements AfterViewInit {
