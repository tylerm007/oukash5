...
@Component({
  selector: 'AchAuthToken-home',
  templateUrl: './AchAuthToken-home.component.html',
  styleUrls: ['./AchAuthToken-home.component.scss']
})
export class AchAuthTokenHomeComponent implements AfterViewInit {
