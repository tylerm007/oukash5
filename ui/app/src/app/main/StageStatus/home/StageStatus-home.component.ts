...
@Component({
  selector: 'StageStatus-home',
  templateUrl: './StageStatus-home.component.html',
  styleUrls: ['./StageStatus-home.component.scss']
})
export class StageStatusHomeComponent implements AfterViewInit {
