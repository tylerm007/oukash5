...
@Component({
  selector: 'PERSONJOBTB-home',
  templateUrl: './PERSONJOBTB-home.component.html',
  styleUrls: ['./PERSONJOBTB-home.component.scss']
})
export class PERSONJOBTBHomeComponent implements AfterViewInit {
