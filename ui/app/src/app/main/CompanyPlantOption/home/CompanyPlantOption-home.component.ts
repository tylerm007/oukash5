...
@Component({
  selector: 'CompanyPlantOption-home',
  templateUrl: './CompanyPlantOption-home.component.html',
  styleUrls: ['./CompanyPlantOption-home.component.scss']
})
export class CompanyPlantOptionHomeComponent implements AfterViewInit {
