...
@Component({
  selector: 'StageInstance-home',
  templateUrl: './StageInstance-home.component.html',
  styleUrls: ['./StageInstance-home.component.scss']
})
export class StageInstanceHomeComponent implements AfterViewInit {
