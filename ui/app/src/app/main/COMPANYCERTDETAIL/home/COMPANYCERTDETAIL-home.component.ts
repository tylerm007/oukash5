...
@Component({
  selector: 'COMPANYCERTDETAIL-home',
  templateUrl: './COMPANYCERTDETAIL-home.component.html',
  styleUrls: ['./COMPANYCERTDETAIL-home.component.scss']
})
export class COMPANYCERTDETAILHomeComponent implements AfterViewInit {
