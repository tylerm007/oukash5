...
@Component({
  selector: 'WFQuoteStatus-home',
  templateUrl: './WFQuoteStatus-home.component.html',
  styleUrls: ['./WFQuoteStatus-home.component.scss']
})
export class WFQuoteStatusHomeComponent implements AfterViewInit {
