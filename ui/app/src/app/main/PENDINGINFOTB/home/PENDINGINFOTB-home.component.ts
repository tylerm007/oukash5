...
@Component({
  selector: 'PENDINGINFOTB-home',
  templateUrl: './PENDINGINFOTB-home.component.html',
  styleUrls: ['./PENDINGINFOTB-home.component.scss']
})
export class PENDINGINFOTBHomeComponent implements AfterViewInit {
