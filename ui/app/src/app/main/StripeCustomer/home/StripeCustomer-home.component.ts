...
@Component({
  selector: 'StripeCustomer-home',
  templateUrl: './StripeCustomer-home.component.html',
  styleUrls: ['./StripeCustomer-home.component.scss']
})
export class StripeCustomerHomeComponent implements AfterViewInit {
