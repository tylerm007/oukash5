...
@Component({
  selector: 'PLANTFEESTRUCTURE-home',
  templateUrl: './PLANTFEESTRUCTURE-home.component.html',
  styleUrls: ['./PLANTFEESTRUCTURE-home.component.scss']
})
export class PLANTFEESTRUCTUREHomeComponent implements AfterViewInit {
