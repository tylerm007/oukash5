...
@Component({
  selector: 'CoPackerFacility-home',
  templateUrl: './CoPackerFacility-home.component.html',
  styleUrls: ['./CoPackerFacility-home.component.scss']
})
export class CoPackerFacilityHomeComponent implements AfterViewInit {
