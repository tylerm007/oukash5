...
@Component({
  selector: 'WFFileType-home',
  templateUrl: './WFFileType-home.component.html',
  styleUrls: ['./WFFileType-home.component.scss']
})
export class WFFileTypeHomeComponent implements AfterViewInit {
