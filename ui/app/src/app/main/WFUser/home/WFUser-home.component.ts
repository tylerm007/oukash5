...
@Component({
  selector: 'WFUser-home',
  templateUrl: './WFUser-home.component.html',
  styleUrls: ['./WFUser-home.component.scss']
})
export class WFUserHomeComponent implements AfterViewInit {
