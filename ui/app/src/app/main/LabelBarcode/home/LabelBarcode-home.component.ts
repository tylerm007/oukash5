...
@Component({
  selector: 'LabelBarcode-home',
  templateUrl: './LabelBarcode-home.component.html',
  styleUrls: ['./LabelBarcode-home.component.scss']
})
export class LabelBarcodeHomeComponent implements AfterViewInit {
