...
@Component({
  selector: 'WFIngredient-home',
  templateUrl: './WFIngredient-home.component.html',
  styleUrls: ['./WFIngredient-home.component.scss']
})
export class WFIngredientHomeComponent implements AfterViewInit {
