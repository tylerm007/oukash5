...
@Component({
  selector: 'WFFile-home',
  templateUrl: './WFFile-home.component.html',
  styleUrls: ['./WFFile-home.component.scss']
})
export class WFFileHomeComponent implements AfterViewInit {
