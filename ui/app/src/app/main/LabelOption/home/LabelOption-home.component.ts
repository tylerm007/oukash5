...
@Component({
  selector: 'LabelOption-home',
  templateUrl: './LabelOption-home.component.html',
  styleUrls: ['./LabelOption-home.component.scss']
})
export class LabelOptionHomeComponent implements AfterViewInit {
