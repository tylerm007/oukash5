...
@Component({
  selector: 'LaneRole-home',
  templateUrl: './LaneRole-home.component.html',
  styleUrls: ['./LaneRole-home.component.scss']
})
export class LaneRoleHomeComponent implements AfterViewInit {
