...
@Component({
  selector: 'PERSONJOBSTATUSTB-home',
  templateUrl: './PERSONJOBSTATUSTB-home.component.html',
  styleUrls: ['./PERSONJOBSTATUSTB-home.component.scss']
})
export class PERSONJOBSTATUSTBHomeComponent implements AfterViewInit {
