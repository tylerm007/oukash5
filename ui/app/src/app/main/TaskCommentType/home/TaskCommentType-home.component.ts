...
@Component({
  selector: 'TaskCommentType-home',
  templateUrl: './TaskCommentType-home.component.html',
  styleUrls: ['./TaskCommentType-home.component.scss']
})
export class TaskCommentTypeHomeComponent implements AfterViewInit {
