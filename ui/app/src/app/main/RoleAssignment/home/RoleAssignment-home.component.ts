...
@Component({
  selector: 'RoleAssignment-home',
  templateUrl: './RoleAssignment-home.component.html',
  styleUrls: ['./RoleAssignment-home.component.scss']
})
export class RoleAssignmentHomeComponent implements AfterViewInit {
