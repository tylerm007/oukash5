...
@Component({
  selector: 'PLANTOTHERNAME-home',
  templateUrl: './PLANTOTHERNAME-home.component.html',
  styleUrls: ['./PLANTOTHERNAME-home.component.scss']
})
export class PLANTOTHERNAMEHomeComponent implements AfterViewInit {
